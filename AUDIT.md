...
4. **`.hermes/plans/`** — actionable implementation plans for milestones. The current completed plan is `2026-07-16_152821-caster-spec-encounter-modules.md`.
